...
mymults <- seq(2, 10, 1)
young.ages <- c(1, 1, 1, 0, 0, 0)
old.ages <- c(0, 0, 0, 1, 1, 1)
...
# now try cmults with 9 year ramp
...
scenario6b.df <- runRetroMults(myscen6, myname, n.peels, 9, 1995, 1, seq(5.5, 5.9, 0.1), young.ages, "Young", 1, FALSE)
scenario6c.df <- runRetroMults(myscen6, myname, n.peels, 9, c(2000, 2015), 1, seq(4.5, 4.9, 0.1), young.ages, "Young", 1, FALSE)
scenario6d.df <- runRetroMults(myscen6, myname, n.peels, 9, c(2005, 2013), 1, seq(4.1, 4.5, 0.1), young.ages, "Young", 1, FALSE)
scenario6e.df <- runRetroMults(myscen6, myname, n.peels, 9, 2010, 1, seq(3.5, 3.9, 0.1), young.ages, "Young", 1, FALSE)
...
scenario7b.df <- runRetroMults(myscen7, myname, n.peels, 9, c(1995, 2000, 2005, 2010, 2013), 1, seq(2.5, 2.9, 0.1), old.ages, "Old", 1, FALSE)
scenario7c.df <- runRetroMults(myscen7, myname, n.peels, 9, 2015, 1, seq(2.5, 2.9, 0.1), old.ages, "Old", 1, FALSE)
...
scenario8b.df <- runRetroMults(myscen8, myname, n.peels, 0, 1995, 1, seq(5.1, 5.5, 0.1), young.ages, "Young", 1, FALSE)
scenario8c.df <- runRetroMults(myscen8, myname, n.peels, 0, c(2000, 2010), 1, seq(4.1, 4.5, 0.1), young.ages, "Young", 1, FALSE)
scenario8d.df <- runRetroMults(myscen8, myname, n.peels, 0, 2005, 1, seq(3.5, 3.9, 0.1), young.ages, "Young", 1, FALSE)
scenario8e.df <- runRetroMults(myscen8, myname, n.peels, 0, 2013, 1, seq(8.5, 8.9, 0.1), young.ages, "Young", 1, FALSE)
...
scenario9b.df <- runRetroMults(myscen9, myname, n.peels, 0, c(1995, 2000, 2005, 2010), 1, seq(2.5, 2.9, 0.1), old.ages, "Old", 1, FALSE)
scenario9c.df <- runRetroMults(myscen9, myname, n.peels, 0, 2013, 1, seq(3.1, 3.5, 0.1), old.ages, "Old", 1, FALSE)
scenario9d.df <- runRetroMults(myscen9, myname, n.peels, 0, 2015, 1, seq(4.5, 4.9, 0.1), old.ages, "Old", 1, FALSE)
...
scenario10b.df <- runRetroMults(myscen10, myname, n.peels, 4, 1995, 1, seq(5.1, 5.5, 0.1), young.ages, "Young", 1, FALSE)
scenario10c.df <- runRetroMults(myscen10, myname, n.peels, 4, 2000, 1, seq(4.3, 4.7, 0.1), young.ages, "Young", 1, FALSE)
scenario10d.df <- runRetroMults(myscen10, myname, n.peels, 4, c(2005, 2010), 1, seq(3.5, 3.9, 0.1), young.ages, "Young", 1, FALSE)
scenario10e.df <- runRetroMults(myscen10, myname, n.peels, 4, 2013, 1, seq(4.5, 4.9, 0.1), young.ages, "Young", 1, FALSE)
scenario10f.df <- runRetroMults(myscen10, myname, n.peels, 4, 2015, 1, seq(8.1, 8.5, 0.1), young.ages, "Young", 1, FALSE)
...
scenario11b.df <- runRetroMults(myscen11, myname, n.peels, 4, c(1995, 2000, 2005, 2010), 1, seq(2.5, 2.9, 0.1), old.ages, "Old", 1, FALSE)
scenario11c.df <- runRetroMults(myscen11, myname, n.peels, 4, 2013, 1, seq(3.1, 3.5, 0.1), old.ages, "Old", 1, FALSE)
scenario11d.df <- runRetroMults(myscen11, myname, n.peels, 4, 2015, 1, seq(3.3, 3.7, 0.1), old.ages, "Old", 1, FALSE)
