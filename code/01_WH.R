...
young.ages <- c(1,1,1,1,0,0,0,0,0)
old.ages <- c(0,0,0,0,0,1,1,1,1)
...
scenario7b.df <- runRetroMults(myscen7, myname, n.peels, 0, c(2000, 2005, 2010), 1, seq(2.1, 2.4, 0.1), old.ages, "Old", 1, FALSE)
...
scenario8b.df <- runRetroMults(myscen8, myname, n.peels, 4, c(2000, 2005, 2010), 1, seq(2.1, 2.4, 0.1), old.ages, "Old", 1, FALSE)

scenario8c.df <- runRetroMults(myscen8, myname, n.peels, 4, 2015, 1, seq(2.6, 2.9, 0.1), old.ages, "Old", 1, FALSE)
...
scenario9b.df <- runRetroMults(myscen9, myname, n.peels, 9, year.vals, 1, seq(2.1, 2.4, 0.1), old.ages, "Old", 1, FALSE)
...
scenario10b.df <- runRetroMults(myscen10, myname, n.peels, 0, c(2000, 2005), 1, seq(3.1, 3.5, 0.1), young.ages, "Young", 1, FALSE)

scenario10c.df <- runRetroMults(myscen10, myname, n.peels, 0, 2010, 1, seq(4.6, 4.9, 0.1), young.ages, "Young", 1, FALSE)
...
scenario11b.df <- runRetroMults(myscen11, myname, n.peels, 4, 2000, 1, seq(3.1, 3.4, 0.1), young.ages, "Young", 1, FALSE)
...
scenario12b.df <- runRetroMults(myscen12, myname, n.peels, 9, c(2000, 2005, 2010), 1, seq(3.1, 3.4, 0.1), young.ages, "Young", 1, FALSE)

scenario12c.df <- runRetroMults(myscen12, myname, n.peels, 9, 2015, 1, seq(4.6, 4.9, 0.1), young.ages, "Young", 1, FALSE)
